...
import com.rescomms.device_calendar_extended.devicecalendar.DayOfWeekSerializer
import com.rescomms.device_calendar_extended.devicecalendar.RecurrenceFrequencySerializer
import com.rescomms.device_calendar_extended.devicecalendar.common.Constants.Companion.ATTENDEE_EMAIL_INDEX
import com.rescomms.device_calendar_extended.devicecalendar.common.Constants.Companion.ATTENDEE_NAME_INDEX
import com.rescomms.device_calendar_extended.devicecalendar.common.Constants.Companion.ATTENDEE_PROJECTION
import com.rescomms.device_calendar_extended.devicecalendar.common.Constants.Companion.ATTENDEE_RELATIONSHIP_INDEX
import com.rescomms.device_calendar_extended.devicecalendar.common.Constants.Companion.ATTENDEE_STATUS_INDEX
import com.rescomms.device_calendar_extended.devicecalendar.common.Constants.Companion.ATTENDEE_TYPE_INDEX
import com.rescomms.device_calendar_extended.devicecalendar.common.Constants.Companion.CALENDAR_PROJECTION
import com.rescomms.device_calendar_extended.devicecalendar.common.Constants.Companion.CALENDAR_PROJECTION_ACCESS_LEVEL_INDEX
import com.rescomms.device_calendar_extended.devicecalendar.common.Constants.Companion.CALENDAR_PROJECTION_DISPLAY_NAME_INDEX
import com.rescomms.device_calendar_extended.devicecalendar.common.Constants.Companion.CALENDAR_PROJECTION_ID_INDEX
import com.rescomms.device_calendar_extended.devicecalendar.common.Constants.Companion.EVENT_PROJECTION
import com.rescomms.device_calendar_extended.devicecalendar.common.Constants.Companion.EVENT_PROJECTION_ALL_DAY_INDEX
import com.rescomms.device_calendar_extended.devicecalendar.common.Constants.Companion.EVENT_PROJECTION_BEGIN_INDEX
import com.rescomms.device_calendar_extended.devicecalendar.common.Constants.Companion.EVENT_PROJECTION_DESCRIPTION_INDEX
import com.rescomms.device_calendar_extended.devicecalendar.common.Constants.Companion.EVENT_PROJECTION_END_INDEX
import com.rescomms.device_calendar_extended.devicecalendar.common.Constants.Companion.EVENT_PROJECTION_EVENT_LOCATION_INDEX
import com.rescomms.device_calendar_extended.devicecalendar.common.Constants.Companion.EVENT_PROJECTION_ID_INDEX
import com.rescomms.device_calendar_extended.devicecalendar.common.Constants.Companion.EVENT_PROJECTION_RECURRING_RULE_INDEX
import com.rescomms.device_calendar_extended.devicecalendar.common.Constants.Companion.EVENT_PROJECTION_TITLE_INDEX
import com.rescomms.device_calendar_extended.devicecalendar.common.Constants.Companion.REMINDER_MINUTES_INDEX
import com.rescomms.device_calendar_extended.devicecalendar.common.Constants.Companion.REMINDER_PROJECTION
import com.rescomms.device_calendar_extended.devicecalendar.common.DayOfWeek
import com.rescomms.device_calendar_extended.devicecalendar.common.ErrorCodes.Companion.GENERIC_ERROR
import com.rescomms.device_calendar_extended.devicecalendar.common.ErrorCodes.Companion.INVALID_ARGUMENT
import com.rescomms.device_calendar_extended.devicecalendar.common.ErrorCodes.Companion.NOT_ALLOWED
import com.rescomms.device_calendar_extended.devicecalendar.common.ErrorCodes.Companion.NOT_AUTHORIZED
import com.rescomms.device_calendar_extended.devicecalendar.common.ErrorCodes.Companion.NOT_FOUND
import com.rescomms.device_calendar_extended.devicecalendar.common.ErrorMessages
import com.rescomms.device_calendar_extended.devicecalendar.common.ErrorMessages.Companion.CALENDAR_ID_INVALID_ARGUMENT_NOT_A_NUMBER_MESSAGE
import com.rescomms.device_calendar_extended.devicecalendar.common.ErrorMessages.Companion.CREATE_EVENT_ARGUMENTS_NOT_VALID_MESSAGE
import com.rescomms.device_calendar_extended.devicecalendar.common.ErrorMessages.Companion.NOT_AUTHORIZED_MESSAGE
import com.rescomms.device_calendar_extended.devicecalendar.models.*
import com.rescomms.device_calendar_extended.devicecalendar.models.Calendar
...
import com.rescomms.device_calendar_extended.devicecalendar.models.CalendarMethodsParametersCacheModel
...
class CalendarDelegate : PluginRegistry.RequestPermissionsResultListener {
    ...
    private fun buildEventContentValues(event: Event, calendarId: String): ContentValues {
        ...
        values.put(Events.DESCRIPTION, event.notes)
    ...
    private fun parseEvent(calendarId: String, cursor: Cursor?): Event? {
        ...
        val notes = cursor.getString(EVENT_PROJECTION_DESCRIPTION_INDEX)
